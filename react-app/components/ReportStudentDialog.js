    ...
    return (
        <>
          ...
          Veuillez nous donner plus de détails..
                ...
                <DialogActions>
                    <div className="12u">
                        <textarea name="report-text" id={`dialog-${student._id}`} style={{ color:"white"}} placeholder="Décrivez ce qui s'est passé.." rows="6" value={reportText} onChange={e=>handleChange(e)}></textarea>
                    </div>
                </DialogActions>
                <DialogActions>
