                            ...
                            <div className="inner">
                                ...
                                <div className="row 200%">
                                    <div className="12u 12u(medium)">
                                        ...
                                        <br /><br />C'est à toi de contacter les élèves par mail/whatsapp/facebook, et de discuter avec eux de la format des séances. N'hésite pas à signaler les élèves qui ne sont pas interéssés ou qui sont injoignables et de prendre d'autres élèves puisqu'il y a plein d'autres en attente d'un tuteur. Finalement, nous te prions de nous faire des compte rendus de chaque séance que tu fais avec tes élèves.
